 ...
 * desc :
 */
public class RecyclerViewItemDecorationStaggeredGridHorizontalActivity extends AppCompatActivity {

    public static void actionStart(Context context) {
        Intent intent = new Intent(context, RecyclerViewItemDecorationStaggeredGridHorizontalActivity.class);
